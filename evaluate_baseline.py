...
def evaluate(beam_size):
    ...
    print(f"[*] Đang chạy Beam Search NO-ATTENTION (Beam size = {beam_size}) trên tập Test...")
    for i in tqdm(range(len(images))):
        ...
        while True:
            ...
            # Không dùng hàm attention, chỉ dùng sigmoid gate kết hợp với h_state
    ...
    print("\n" + "="*45)
    print(f"🎉 KẾT QUẢ MÔ HÌNH NO-ATTENTION:")
