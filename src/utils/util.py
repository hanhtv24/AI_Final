...
# --- CÁC HÀM TIỆN ÍCH ---
# Bạn giữ nguyên các hàm evaluate, clip_gradient, save_checkpoint_caption, AverageMeter, adjust_learning_rate, accuracy_top_k... ở file cũ của bạn.

# [HƯỚNG DẪN SỬA Hàm train_caption]
# Bạn cần đổi tham số đầu vào (thêm cfg và device), đồng thời trả về loss để đưa vào Tensorboard
def train_caption(train_loader, encoder, decoder, criterion, encoder_optimizer, decoder_optimizer, epoch, cfg, device):
    ...
    # Trả về loss và accuracy để ghi vào TensorBoard
...
def validate_caption(val_loader, encoder, decoder, criterion, word_map, cfg, device):
    ...
    # Trả về cả bleu4 và loss để ghi vào TensorBoard
